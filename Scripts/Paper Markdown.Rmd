...
Regardless of weighting scheme, the same 2-3 hour difference in hours shows up across each regression. This in important in two ways. First, it validates the theoretical notion that those closer to the relevant constraint will be more sensitive to it. 
...
relevant_pop_placebos %>%
  ...
  scale_color_manual(breaks = c("just above","placebo high","placebo low","just below","not used"),
                     values = c("steelblue2","tomato4","steelblue4","tomato2","white"))+
